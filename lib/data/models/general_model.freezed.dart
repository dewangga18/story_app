...
class _$GeneralResponseImpl implements _GeneralResponse {
  const _$GeneralResponseImpl({this.error, this.message});
  ...
  @override
  String toString() {
    return 'GeneralResponse(error: $error, message: $message)';
  }
...
abstract class _GeneralResponse implements GeneralResponse {
  const factory _GeneralResponse({final bool? error, final String? message}) =
