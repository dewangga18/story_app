...
class _$AuthPayloadImpl implements _AuthPayload {
  const _$AuthPayloadImpl({this.name, this.email, this.password});
  ...
  @override
  String toString() {
    return 'AuthPayload(name: $name, email: $email, password: $password)';
  }
...
abstract class _AuthPayload implements AuthPayload {
  const factory _AuthPayload(
      {final String? name,
      final String? email,
      final String? password}) = _$AuthPayloadImpl;
